...
async function askEducationYear(bot, chatID) {
  await bot.sendMessage(chatID, 'Выбери свой год обучения: ', {
    reply_markup: {
      inline_keyboard: [
        [
          { text: '1', callback_data: '1EducationYear' },
          { text: '2', callback_data: '2EducationYear' },
        ],
        [
          { text: '3', callback_data: '3EducationYear' },
          { text: '4', callback_data: '4EducationYear' },
        ],
      ],
    },
  })
...
async function askEducationalGroup(bot, chatID) {
  const prompt = await bot.sendMessage(
    chatID,
    'Напиши название своей учебной группы, например, "ТХ-10-1"',
    {
      reply_markup: {
        force_reply: true,
      },
