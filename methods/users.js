  ...
  return new Promise((resolve, reject) => {
    ...
    readFile(jsonPath, "utf8", (error, data) => {
      ...
      if (isNewUser) {
        ...
        newPerson.otherInfo.isUserDataSent =
          checkIsAllFieldsComplete(newPerson);
        if (newPerson.otherInfo.isUserDataSent)
          newPerson.otherInfo.registrationDate = createDate();
        parsedData.push(newPerson);
      }
