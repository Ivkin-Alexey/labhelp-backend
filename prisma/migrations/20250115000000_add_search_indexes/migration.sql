-- Добавление индексов для оптимизации поиска оборудования
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_brand_gin" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_serial_number" 
ON "Equipment" ("serialNumber") WHERE "serialNumber" IS NOT NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_inventory_number" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_model_id" 
ON "Equipment" ("modelId");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_department_id" 
ON "Equipment" ("departmentId");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_classification_id" 
ON "Equipment" ("classificationId") WHERE "classificationId" IS NOT NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_measurement_id" 
ON "Equipment" ("measurementId") WHERE "measurementId" IS NOT NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_type_id" 
ON "Equipment" ("typeId") WHERE "typeId" IS NOT NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_kind_id" 
ON "Equipment" ("kindId") WHERE "kindId" IS NOT NULL;

-- Составной индекс для группировки по modelId и departmentId
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_model_department" 
ON "Equipment" ("modelId", "departmentId");

-- Индексы для связанных таблиц
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_model_name" 
ON "Model" ("name");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_department_name" 
ON "Department" ("name");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_classification_name" 
ON "Classification" ("name");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_measurement_name" 
ON "Measurement" ("name");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_type_name" 
ON "EquipmentType" ("name");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_kind_name" 
ON "EquipmentKind" ("name");

-- Индекс для сортировки по imgUrl
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_equipment_img_url" 
